...
pairThatSumsTo2020 :: Int -> [Int] -> Int
pairThatSumsTo2020 first following = do
  let candidate = 2020 - first
  let match = filter  (== candidate) following
  let outcome = case match of 
